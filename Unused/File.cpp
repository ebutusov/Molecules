...
//-----------------------------------------------------------------------------
void CXFile::Open(string strFileName,			// file name 
...
//-----------------------------------------------------------------------------
void CXFile::Rename(string strOldName, string strNewName)
{
...
//-----------------------------------------------------------------------------
void CXFile::Remove(string strFileName)
{
...
//-----------------------------------------------------------------------------
void CXFile::SetFilePath(string strNewName)
{
	_ASSERT(m_hFile && ((m_hFile) != INVALID_HANDLE_VALUE));

	// Make sure it's a file path
	int nPos = strNewName.find(":\\");
	if (nPos == -1)
		_ASSERT(FALSE);	
...
//-----------------------------------------------------------------------------
string CXFile::GetFilePath() const
{
	_ASSERT(m_hFile && ((m_hFile) != INVALID_HANDLE_VALUE));
